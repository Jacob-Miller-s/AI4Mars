...
PILOT_SIZE = 150
CALIBRATION_SIZE = 24
PRODUCTION_SIZE = PILOT_SIZE - CALIBRATION_SIZE
...
def prepare_production_review(
    *, source_pilot_manifest: Path, component_manifest: Path, calibration_manifest: Path,
    ...
    state = initialize_review_state(copied_pilot_path, Path(dataset_root), pilot_id="rock_instance_pilot_v1_production_v2.3")
    ...
    configure_frozen_production_review(
        ...
        source_pilot_manifest=source_pilot_manifest,
    ...
    provenance_path.write_text(
        json.dumps(
            {
                "schema_version": "rock_instance_production_review_provenance_v1",

...
from src.dataset import AI4MarsDataset, load_pairs_from_manifest, normalize_ai4mars_mask
    ...
    *,
    ...
    if args is not None:
        ...
        for key, value in (
            ...
            ("batch_log_interval", args.batch_event_logging_interval),
        ...
        RunMetadata(
            ...
            provenance=ProvenanceRecord(
                ...
                protocol=ProtocolRecord(
                    valid=True,
                    notes=[
                        "Expert masks are evaluated only by src.paper_evaluate against a frozen checkpoint, never during training."
                    ],
                ),
    ...
    try:
        for epoch in range(start_epoch, int(training["epochs"]) + 1):
            ...
            train_result = train_one_epoch(
                ...
                epoch=epoch,
                run_logger=logger,
                batch_log_interval=int(training["batch_log_interval"]),
